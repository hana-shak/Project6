        ...
        // <iframe width={'100%'} height={650} src="https://www.youtube.com/embed/Y0-qdp-XBJg" frameBorder={0} allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen />
          ...
          <div className="carousel-inner">
            <div className="carousel-item active">
              <img src="courses/coding_slider1.jpeg" className="d-block w-100" alt="..." />
            </div>
            <div className="carousel-item">
              <img src="courses/css_slider.jpg" className="d-block w-100" alt="..." />
            </div>
            <div className="carousel-item">
              <img src="courses/languages_slider.jpg" className="d-block w-100" alt="..." />
            </div>
          </div>
